  ...
  return (
    <BlurFade className="relative z-20 -mt-16 pb-24 md:pb-32" offset={30}>
      <div className="mx-auto max-w-3xl px-6">
        <div className="gradient-border grid grid-cols-1 sm:grid-cols-3 rounded-2xl border border-border/50 bg-card/60 backdrop-blur-xl p-6 gap-4 shadow-xl shadow-black/[0.03]">
          {[
            ...
            <div key={label} className="text-center">
              <div className="text-2xl md:text-3xl font-extrabold tracking-tight text-foreground font-display">
                <NumberTicker value={value} className="text-foreground font-extrabold" />
                <span>{suffix}</span>
              </div>
