...
<div className="mt-6 flex items-center justify-center gap-4 text-xs text-muted-foreground">
  <span className="flex items-center gap-1"><Shield className="h-3 w-3" /> Secure login</span>
...
<p className="text-center text-xs text-muted-foreground mt-3">
  Press <kbd className="rounded border border-border px-1.5 py-0.5 text-[10px] font-mono">Enter</kbd> to sign in
</p>
```
